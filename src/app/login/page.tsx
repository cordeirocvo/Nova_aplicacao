...
export default function LoginPage() {
  ...
  useEffect(() => {
    document.title = "Login | Cordeiro Energia";
  }, []);
        ...
        <div className="relative w-full max-w-md p-8 bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl mx-4">
          <div className="flex flex-col items-center mb-8">
            <div className="w-56 h-auto flex items-center justify-center mb-6">
              <img src="/logo-white.svg" alt="Cordeiro Energia Logo" className="object-contain w-full drop-shadow-lg" />
            </div>
            <p className="text-slate-400 mt-1 text-sm text-center">Entre para gerenciar suas tarefas e instalações.</p>
          </div>
